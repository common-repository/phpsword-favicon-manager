...
* Homepage of [Pk Favicon Manager Plugin](https://pkplugins.com/ "WordPress plugin to display favicon image") for WordPress at pkplugins.com
...
2. On the Plugins installation page, under the Search navigation menu, enter 'Pk Favicon Manager' in the search bar and click 'Search Plugins.'
3. You will find 'Pk Favicon Manager plugin By Pradnyankur Nikam' in the list.
...
= Manual Installation =
1. To install the plugin manually, visit [Pk Favicon Manager WordPress plugin](https://wordpress.org/plugins/phpsword-favicon-manager/ "WordPress plugin to change favicon image") description page.
2. Click the 'Download Version 1.0' button on the page to download and save the plugin zip file named `pk-favicon-manager.zip` to your computer.
3. Login to your WordPress admin panel. Go to Plugins -> Add New -> select 'Upload' navigation on the page. Click the 'Browse' button, select the downloaded `pk-favicon-manager.zip` file from your computer and click the 'Install Now' button. WordPress will upload and automatically extract and install the plugin in the appropriate directory for you.
<br />
**OR**
<br />
Extract the `pk-favicon-manager.zip` file and upload all the files inside 'pk-favicon-manager.zip' folder to your website's `wp-content/plugins` directory. Go to plugins and activate the Pk Favicon Manager plugin from the list.
4. Reload the WordPress Admin Panel and you will see a new menu 'FaviconManger' on the left sidebar menu of you administrator panel.
5. Click and open the 'FaviconManger' page. Here you can upload your own favicon images to your WordPress website.
...
== Screenshots ==
1. Pk Favicon Manager Screenshot 1
2. Pk Favicon Manager Screenshot 2

== Changelog ==
= 2.1 =
* Added support to the latest WordPress release. That is WordPress 6.4.2
* Updated some broken links.
* The version was updated on 28 December 2023.
= 2.0 =
* Major coding changes has been done.
* Fixed some small bugs.
* The new version is available from 02 December 2022.
= 1.0 =
* First version of the Pk Favicon Manager WordPress plugin released and available to download on 09 November 2014.
...
= License =
Pk Favicon Manager WordPress plugin is released under the GPLv2. You can download, install and use this plugin for free on your personal or commercial website.